...
my %label = 'fr' => %(
               ...
               , 'TIT06' => 'Multiplication de #1# et #2#, procédé "gelosia" (A), base #3#'
               , 'TIT07' => 'Multiplication de #1# et #2#, procédé "gelosia" (B), base #3#'
               , 'TIT08' => 'Multiplication de #1# et #2#, procédé "galea", base #3#'
               ...
               , 'TIT12' => 'Division de #1# par #2#, procédé "galea", base #3#'
          ...
          , 'en' => %(
               ...
               , 'TIT06' => 'Multiplication of #1# and #2#, "gelosia" processus (A), radix #3#'
               , 'TIT07' => 'Multiplication of #1# and #2#, "gelosia" processus (B), radix #3#'
               , 'TIT08' => 'Multiplication of #1# and #2#, "galea" processus, radix #3#'
               ...
               , 'TIT12' => 'Division of #1# by #2#, "galea" processus, radix #3#'
